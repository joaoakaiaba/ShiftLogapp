...
public class MSSQLConnectionHelper {
    ...
    private static String mStringServerIpName = "BD_ShiftLog.mssql.somee.com";
    private static String mStringUserName = "Feehsilva_SQLLogin_2";
    private static String mStringPassword = "zyofnloyt2";
    private static String mStringDatabase = "BD_ShiftLog";
