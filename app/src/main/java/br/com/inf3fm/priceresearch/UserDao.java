...
public class UserDao {
    ...
    public static int insertUser(User mUser, Context mContext){
        ...
        try{
            mSql = "Insert into usuario (Senha, NomeUsuario) values (?, ?, ?, ?)";
    ...
    public static String authenticateUser(User mUser, Context mContext){
        ...
        try{
            ...
            mSql = "SELECT id, email, password FROM usuario WHERE password like ? and email like ?";
...
//            mPreparedStatement.setString(2, "%" + mUser.getEmail() + "%");
    ...
    public static int deleteProduct(User usuario, Context mContext){
        ...
        try{
            ...
            PreparedStatement mPreparedStatement = MSSQLConnectionHelper.getConnection(mContext).prepareStatement(mSql);
            mPreparedStatement.setInt(1, usuario.getId());
