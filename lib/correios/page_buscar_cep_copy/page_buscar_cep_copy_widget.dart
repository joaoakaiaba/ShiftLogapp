...
import 'page_buscar_cep_copy_model.dart';
export 'page_buscar_cep_copy_model.dart';

class PageBuscarCepCopyWidget extends StatefulWidget {
  const PageBuscarCepCopyWidget({Key? key}) : super(key: key);

  @override
  _PageBuscarCepCopyWidgetState createState() =>
      _PageBuscarCepCopyWidgetState();
}

class _PageBuscarCepCopyWidgetState extends State<PageBuscarCepCopyWidget> {
  late PageBuscarCepCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PageBuscarCepCopyModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Align(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('calendarioPage');
                          },
                          text: 'Avançar',
                          options: FFButtonOptions(
